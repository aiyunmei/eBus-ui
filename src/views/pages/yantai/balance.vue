...
<script>
  ...
  import { getCardInfo, getYanTaiCardBalance } from '../../../utils/http'
  ...
  export default {
    ...
    methods: {
      onReady () {
        ...
        getCardInfo({
          Vue: this,
          cb: ({ alipayCardNo }) => this.doGetYanTaiCardBalance(alipayCardNo)
        })
      },
      doGetYanTaiCardBalance (alipayCardNo) { // 执行烟台的查询卡余额
        getYanTaiCardBalance({
          alipayCardNo,
