window.threeConfig = {
  ...
  "openCard": {
    ...
    "getCardBtnVal": "立即领卡",
    "getCardHref": "https://memberprod.alipay.com/account/openform/activecard.htm?app_id=2017121300671681&template_id=2018020821560428520683872&__webview_options__=canPullDown%3dNO%26transparentTitle%3dauto&callback=https://xmbus.i-xiaoma.com.cn:8080/2017121300671681/cardIn&biz_type=scard",
    "cardDescription": {
      "01": {
        "header": "先乘车、后付款",
  ...
  "openLine": {
    ...
    "openLineOptions": [
      {"txt": "907路", "start": "纺织城火车站", "end": "新合"},
      {"txt": "X101路", "start": "昆明路·富源二路口", "end": "阿房宫高铁站"},
      {"txt": "X102路", "start": "劳动路", "end": "公园南路北口"},
      {"txt": "611路", "start": "火车站", "end": "汉城路"}
    ]
  }
}
